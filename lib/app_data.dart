...
//يحتوي ع كل الداتا تبع التطبيق شكل وتصميم كل كرت بالشاشه الرائيسيه الجاهز
...
const Trips_data = const [
  Trip(
    ...
    duration: 20,
    activities: [
      'Tarihi yerler ziyaret etmek',
      'yürüyüş turu',
      'Alışveriş merkezlerini ziyaret etmek',
      'Öğlen yemeği yemek',
      'Güzel manzaralara bakarak zevk almak'
    ],
    program: [
      'Kahvaltı yaparız ve yüzmeye gideriz vs...',
      'Dağlara tırmanmak ve öğle yemeği yemek vs..',
      'Kahvaltı yaparız ve yüzmeye gideriz vs...',
      'Dağlara tırmanmak ve öğle yemeği yemek vs..',
    ],
    isInSummer: false,
  ...
  Trip(
    ...
    activities: [
      ...
      'Alışveriş merkezlerini ziyaret etmek',
      'Öğlen yemeği yemek',
      'Güzel manzaralara bakarak zevk almakة'
    ],
    program: [
      'Kahvaltı yaparız ve yüzmeye gideriz vs...',
      'Dağlara tırmanmak ve öğle yemeği yemek vs..',
